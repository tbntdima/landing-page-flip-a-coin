      ...
      return (
          <div className="coin-container">
              <div className="coin" ref={div => this.coin = div}>
                  <a href="https://planet7casino.com"
                    onClick={(event) => {
                    ...
                    className={this.props.buttonDisabled ? 'coin__front coin__front--disabled' : 'coin__front'}
                  ...
                  <a href={`http://planet7casino.com/webplay/?cashier&coupon=${this.props.currentPromo.coupon}`}
                  ...
                  <a
                    ...
                    href={`http://planet7casino.com/webplay/?cashier&coupon=${this.props.currentPromo.coupon}`}
                    ref={div=> this.coinBonus = div}
                  >Get bonus</a>
              </div>

              <Button
                className={this.props.buttonDisabled ? 'coin__button' : 'coin__button coin__button--visible'}
              ...
              {/* Utilities */}
              <ImagesPreloader imagesList={[initialCoinFront, initialCoinBack, flipButton, flipButtonAgain]} />
              <ReactResizeDetector handleWidth={true} handleHeight={false} onResize={this.onResize}/>
          </div>
      );
    }
